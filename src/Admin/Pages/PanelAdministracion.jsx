...
const PanelAdministracion = () => {
  ...
  const evaluateStatusBtn = (idPropiedad) => {
    return (
      <div className="font-extrabold flex items-center gap-x-6">
        <Tooltip content="Editar propiedad" placement="top">
        <button onClick={(e)=>{handleOpenModalEdit(e,idPropiedad)}} className="rounded-lg  relative w-12 h-10 overflow-x-hidden cursor-pointer flex items-center border border-blue-500 bg-blue-300 group  active:bg-blue-500 active:border-blue-500" href="{{ route('process.create') }}">
        ...
        <button onClick={(e)=>{handleOpenModalView(e,idPropiedad)}} className="rounded-lg  relative w-12 h-10 overflow-x-hidden cursor-pointer flex items-center border border-gray-500 bg-gray-300 group active:bg-gray-500 active:border-gray-500" href="{{ route('process.create') }}">
        ...
        <button onClick={(e)=>{handleOpenModalMaintence(e,idPropiedad)}} className="rounded-lg  relative w-12 h-10 overflow-x-hidden cursor-pointer flex items-center border border-yellow-500 bg-yellow-300 group active:bg-yellow-500 active:border-yellow-500" href="{{ route('process.create') }}">
        ...
        <Tooltip content="Borrar propiedad" placement="top">
        <button onClick={(e)=>{handleDeptoDelete(e,idPropiedad)}} className="rounded-lg  relative w-12 h-10 overflow-x-hidden cursor-pointer flex items-center border border-red-500 bg-red-300 group active:bg-red-500 active:border-red-500" href="{{ route('process.create') }}">
  ...
  const handleDeptoDelete = (idPropiedad) => {
    try {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          console.log(borrarDepartamento)
          Swal.fire({
            icon: 'success',

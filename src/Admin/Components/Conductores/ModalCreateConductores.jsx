...
import { CreateNewConductor } from "../../Api";
...
const ModalCreateConductores = ({onClose,showModal}) => {
  ...
  const handleSubmitForm = async (formData) => {
    try {
      ...
      Swal.fire({
        ...
        text: 'El conductor se ha creado correctamente',
...
ModalCreateConductores.propTypes = {
  onClose: PropTypes.func.isRequired,
  showModal: PropTypes.bool.isRequired,
}

export default ModalCreateConductores;

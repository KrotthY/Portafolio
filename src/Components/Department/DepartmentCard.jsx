...
const DepartmentCard = ({imgSrc, title, location,description, price,  qualification, idApartment }) => {
  return (
    <>
      <div className="cards my-2 mx-2 max-w-xs  rounded bg-white  text-gray-700 shadow-xl">
          ...
          <div className="p-6">
            ...
            <div className="flex flex-col items-center">
              <p className="block font-sans text-base font-light leading-relaxed text-gray-700 antialiased h-36">
                { description }
              </p>
              <p className=" font-sans text-base font-light leading-relaxed text-gray-700 antialiased ">
                  ${price}
                </p>
            </div>

  ...
  return (
    <>
      <div className="flex flex-wrap justify-around items-center gap-4">
        <div className="flex flex-col sm:flex-row items-center bg-gray-50 p-6 w-full sm:w-auto justify-around"> 
        ...
        <div className="flex flex-col sm:flex-row gap-4 bg-gray-50 p-6 w-full sm:w-auto justify-around">
        ...
        <div className="flex items-center gap-4 bg-gray-50 p-6 w-full font-semibold sm:w-auto">

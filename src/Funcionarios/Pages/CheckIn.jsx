...
import ModalRegistroEntrada from "../Components/Modal/Modal";
...
const CheckInFuncionario = () => {
      ...
      case 1:
        return (
          <div className="font-extrabold flex items-center gap-x-6">
            <button onClick={handleOpen} className="rounded-lg  relative w-40 h-10 overflow-x-hidden cursor-pointer flex items-center border border-green-500 bg-green-300 group  active:bg-green-500 active:border-green-500" href="{{ route('process.create') }}">
            ...
            <button className="rounded-lg  relative w-40 h-10 overflow-x-hidden cursor-pointer flex items-center border border-red-500 bg-red-300 group active:bg-red-500 active:border-red-500" href="{{ route('process.create') }}">
  ...
  return (
    ...
    <div className="bg-gray-100 p-3 sm:p-5">
      ...
      <ModalRegistroEntrada showModal={showModal} onClose={closeModal} />
  </section>
    </>
  );
};
